...
# this line for first progressBar
for c in z:
...
istsehir = {"1":"http://ibb-media1.ibb.gov.tr:1935/live/223.stream/chunklist_w1088399288.m3u8", #Mecidiyeköy
	...
	"6":"http://ibb-media4.ibb.gov.tr:1935/live/58.stream/chunklist_w506610889.m3u8",    #Büyükdere caddesi Maslak
...
kocaeli_sehir = {"1":"https://content.tvkur.com/l/c8h3cnnmm25qqqh924s0/master.m3u8", #Cumhuriyet Bulvarı - 1
	"2":"https://content.tvkur.com/l/c8ae46nmm25ncvht1om0/master.m3u8", #Cumhuriyet Bulvarı - 2
	"3":"https://content.tvkur.com/l/c8h3fufmm25qqqh92540/master.m3u8", #İzmit Umuttepe
	"4":"https://content.tvkur.com/l/c9uh1dnbb2nlkm3l3lng/master.m3u8", #İzmit Saat Kulesi
	"5":"https://content.tvkur.com/l/c6v3suj84cnued13bc50/master.m3u8", #Çayırova Kent Meydanı
    "6":"https://content.tvkur.com/l/c8h3jsfmm25qqqh925eg/master.m3u8", #Körfez Kent Meydanı
    "7":"https://content.tvkur.com/l/c8lpusvbb2nug7mh97hg/master.m3u8", #Gebze Balkan Türkleri Parkı
    "8":"https://content.tvkur.com/l/cakpds7mm25l7akbhka0/master.m3u8", #İzmit Cumhuriyet Parkı
    "9":"https://content.tvkur.com/l/c8h3jd7mm25qqqh925dg/master.m3u8"  #Gölcük Anıt Park
    }
...
def secim():
    if(kameraturu == 1 and sehirturu == 1):
        ...
        return secilenkamera
    elif(kameraturu == 2 and sehirturu == 6):
        print(f"{bred}[ 1 ]{bos} Cumhuriyet Bulvarı - 1\n{bred}[ 2 ]{bos} Cumhuriyet Bulvarı - 2\n{bred}[ 3 ]{bos} İzmit Umuttepe\n{bred}[ 4 ]{bos} İzmit Saat Kulesi 2\n{bred}[ 5 ]{bos} Çayırova Kent Meydanı\n{bred}[ 6 ]{bos} Körfez Kent Meydanı\n{bred}[ 7 ]{bos} Gebze Balkan Türkleri Parkı\n{bred}[ 8 ]{bos} İzmit Cumhuriyet Parkı\n{bred}[ 9 ]{bos} Gölcük Anıt Park\n")
        kambolge = str(input())
        secilenkamera = kocaeli_sehir[kambolge]
        return secilenkamera
